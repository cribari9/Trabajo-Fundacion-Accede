        ...
        <article class="row">
          ...
          <div class="col-lg-6 g-mb-30">
            ...
            <div class="g-pl-90--sm">
              <p class="lead g-mb-40" align="justify" style="white-space: pre-line;">{{$evento->descripcion}}</p>
              ...
              <div align="center"><button id="btnInscripcion" href="#" class="btn u-shadow-v21 g-bg-white g-color-primary g-color-black--hover  btn-outline-success g-bg-white-opacity-0_4--hover g-font-size-12 text-uppercase g-font-weight-600 g-rounded-50 g-py-12 g-px-20">
                     Inscribirse</div>
              @else
